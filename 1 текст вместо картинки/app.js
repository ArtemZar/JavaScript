...
function handleClick(clickedButtonEvent) {
    ...
    // const cardNode = ;
    // target это сам элемент по которому произошло событие
    // parentNude это родительский узел
...
function showMoreText(card) {
    ...
    let moreInfo = 'ПодробноПодробноПодробноПодробноПодробноПодробноПодробно'
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${moreInfo}</div>`);
